...
;(function($){
        ...
        /**
         * Menu Tree Node
         * handle child menu display & active status
         */
                ...
                self.scrollListener = function(scrollTop) {
                        ...
                        self.eachNode(function(node) {
                                if (node.position < scrollTop + 10) {
                                        // When scrolled to the node position, active that node.
                                        active = node;
                                } else {
                                        return false;
                                }
        ...
        /**
         * Control menu position, make menu display at a proper position.
         */
